...
| `users` | id、LINE user ID、出生年、性別コード、都道府県コード、作成日時、更新日時 | LINE/LIFF認証とユーザープロフィールを保持する。LINE user IDは一意、出生年・性別・都道府県は未入力をNULLで保持する |
...
- ユーザープロフィールには生年だけを保存し、投稿時に年代へ変換する。生年月日や正確な年齢は保存しない
