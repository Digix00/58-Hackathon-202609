...
- 表紙のあいだは、本の下にクレヨンのシールを敷く。フィードの表紙と同じ絵・同じ貼りかたにして、同じノートの表紙として見せる。シールは紙の外側の飾りであり、紙の中には入れない。
- 表紙のあいだは本を少し小さく置き、「ひらいてみる」で本が広がりながらシールが外へ散る。書きはじめを、手続きの開始ではなくノートを開く動作として見せる。
...
- めくりを減らす設定のときは、紙を回さずに切り替える。シールも散らさず、貼ってあるだけにする。
