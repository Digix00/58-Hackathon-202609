...
しおりと切り欠きは同じ型紙で描き、片方がもう片方に収まることを形で示す。切り欠きは各手紙の上端に置き、しおりをそれぞれの紙の上に貼るように差し込む。結果でも書き手のしおりを同じ位置に残す。しおりは1人1枚しかなく、別の手紙に挟んであればそちらから抜けてくる。重複した選択は起こりようがないため、選び直しを促すエラーは表示しない。紙の地色は手紙ごとに変えず、人の区別はしおりの色で行う。色だけで意味を伝えず、しおりには匿名ラベルを併記する。回答前は正解を示す色を使わない。
