...
CREATE TABLE `__new_concerns` (
	...
	CONSTRAINT "concerns_visibility_status_check" CHECK("__new_concerns"."visibility_status" in ('pending', 'published', 'hidden', 'deleted')),
...
INSERT INTO `__new_concerns`("id", "user_id", "body", "age_group", "gender_code", "region_code", "visibility_status", "processing_status", "created_at", "updated_at") SELECT "id", "user_id", "body", "age_group", "gender_code", "region_code", "visibility_status", "processing_status", "created_at", "updated_at" FROM `concerns`;--> statement-breakpoint
