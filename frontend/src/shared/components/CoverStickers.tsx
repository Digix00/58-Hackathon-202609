 ...
 * 弾かれるように外へ散っていく。開く瞬間を読みはじめ・書きはじめの合図にする。
 *
 * 読む本（フィード）と書く本（はじめの1ページ）で同じ絵を貼るので、画面ごとに
 * 持たず共有で置く。同じノートの表紙という約束が、貼ってある絵でも伝わる。
 *
 ...
 * Composition: 表紙を持つ画面の紙束の中に、紙より先に置いて紙の下へ潜らせる。
 */
